...
本项目通过 [JitPack](https://jitpack.io/) 分发。请在 Maven 项目中添加 JitPack 仓库和依赖：
...
| 版本 | 说明 |
|------|------|
| `0.1.0-SNAPSHOT` | 最新开发版本 |
| `main-SNAPSHOT` | 最新开发构建（包含未发布特性，如手机号生成） |
| `{commit-hash}` | 指定 commit 构建（如 `7f285d2`） |
